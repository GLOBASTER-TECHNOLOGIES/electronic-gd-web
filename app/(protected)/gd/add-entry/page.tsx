...
export default function AddGDEntryPage() {
  ...
  const handleFinalSubmit = async () => {
    ...
    const payload = {
      ...
      acknowledged: true,
      timeOfSubmission: exactClickTime,
    };
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="flex items-start gap-3 border-2 border-gray-200 bg-gray-50 p-6">
                  ...
                  <label className="text-sm font-medium leading-relaxed">
                    I, {user.name} ({user.rank}), acknowledge that everything I have entered is correct and truthful.
                    I understand that this is an official record and cannot be modified after submission.
                  </label>
                </div>

                <p className="text-[15px] text-gray-400 font-medium leading-tight">
