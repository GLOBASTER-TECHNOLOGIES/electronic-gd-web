...
export default function PostsDashboard() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const userType = meRes.data.userType;
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="md:col-span-2 space-y-6">
                      <div>
                        ...
                        <p className="text-sm font-bold text-blue-700 mt-1 uppercase tracking-wide">
                          {post.division} Division | Southern Railway
                        </p>
                      </div>
                      ...
                      <div className="flex gap-10 border-t border-gray-100 pt-6">
                        <div>
                          ...
                          <p className="text-lg font-bold text-slate-800 flex items-center gap-2">
                            <Phone size={16} /> {post.contactNumber || "N/A"}
                          </p>
                        </div>
                        <div>
                          <label className="text-[10px] font-bold text-gray-400 uppercase block mb-1">
                    ...
                    <div className="bg-gray-50 p-6 border border-gray-200 rounded-lg flex flex-col justify-center items-center text-center">
                      ...
                      <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block mb-2 underline">
                        In-Charge Details
                      </label>
                      ...
                      <p className="text-xs font-mono font-bold text-gray-500 mt-2">
                        Force No: {post.officerInCharge?.forceNumber || "---"}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      <h4 className="text-sm font-bold uppercase text-slate-900 leading-tight">
                        Add GD Entry
                      </h4>
                      <p className="text-[10px] font-medium text-gray-500 uppercase tracking-wider">
                        (Visiting Officer)
                ...
                {/* ✅ CREATE OFFICER (REPLACED SERIAL NUMBER) */}
                <button
                  // onClick={() => router.push("/create-officer")}
                  onClick={() => router.push(`/post/manage-officer`)}
                  className="bg-white border border-gray-300 p-5 hover:bg-gray-50 flex items-center justify-between transition-colors group shadow-sm"
                >
                  <div className="flex items-center gap-4">
